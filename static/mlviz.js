...
function init_scene(flower_data, ranges, labels) {
    ...
    // Orbit Controls
    var focus_location = new THREE.Vector3((plot.mesh_ranges[0][0]+plot.mesh_ranges[0][1])/2,
					                                 (plot.mesh_ranges[1][0]+plot.mesh_ranges[1][1])/2,
					                                 (plot.mesh_ranges[2][0]+plot.mesh_ranges[2][1])/2 );
